...
import com.rainist.collectcard.common.converter.CardBillScheduledEncryptConverter
...
@Table(name = "card_bill_scheduled_history")
data class CardBillScheduledHistoryEntity(

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    var cardBillScheduledHistoryId: Long? = null,
    ...
    @Convert(converter = CardBillScheduledEncryptConverter::class)
